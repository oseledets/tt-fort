...
!-------------------------------------------------------
     ...
     PRIMMEF77_dynamicMethodSwitch = 49, PRIMMEF77_massMatrixMatvec = 50 )


      integer PRIMMEF77_smallest, &
     PRIMMEF77_largest, &
     ...
     PRIMMEF77_adaptive
      ...
      parameter(PRIMMEF77_smallest = 0, &
     PRIMMEF77_largest = 1, &
