...
void primme_set_member_f77(primme_params **primme, int *label, void *ptr){
   ...
   switch (*label) {
      ...
      break;
      default : 
      fprintf(stderr,"Requested member does not exist: consult primme_f77.h.");
 ...
 *
 * To be called from withing MV, PRECOND, or GLOBALSUM ---NOT from the driver
 * For obtaining information from the driver, see below.
 *
...
void primme_get_member_f77(primme_params *primme, int *label, void *ptr){
   ...
   switch (*label) {
      ...
      break;
      case PRIMMEF77_massMatrixMatvec:
	      ptr = (void *) primme->massMatrixMatvec;
      break;
      case PRIMMEF77_applyPreconditioner:
	      ptr = (void *) primme->applyPreconditioner;
      break;
      case PRIMMEF77_numProcs:
      ...
      break;
      case PRIMMEF77_globalSumDouble:
	      ptr = (void *) primme->globalSumDouble;
      break;
      case PRIMMEF77_numEvals:
      ...
      break;
      case PRIMMEF77_intWork:
	      ptr = (void *) primme->intWork;
      break;
      case PRIMMEF77_realWork:
	      ptr = (void *) primme->realWork;
      break;
      case PRIMMEF77_aNorm:
      ...
      break;
      case PRIMMEF77_outputFile:
	      ptr = (void *) primme->outputFile;
      break;
      case PRIMMEF77_matrix:
	      ptr = primme->matrix;
      break;
      case PRIMMEF77_preconditioner:
	      ptr = primme->preconditioner;
      break;
      case PRIMMEF77_restartingParams_scheme:
